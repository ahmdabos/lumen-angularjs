...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $commonDutchLastNames = array(
        ...
        'van der Wal', 'Prins', 'Blom', 'Huisman', 'Peeters', 'de Jonge', 'Kuipers', 'van Veen', 'Article', 'Kuiper',
    ...
    protected static $dutchLastNames = array(
        ...
        'Article', 'Potters', 'van der Pouw', 'van Praagh', 'Pratt', 'Prinsen', 'Puig', 'Rackham', 'Rademaker', 'Ramaker',
